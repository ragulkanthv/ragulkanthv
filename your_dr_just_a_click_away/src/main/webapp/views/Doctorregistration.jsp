...
<html lang="en">
  ...
  <%
    ...
    <div class="conatiner-fluid">
      ...
      <div class="content" style="background-color: rgb(237, 237, 222);width: full;">
        <div class="row">
          ...
          <div class="col-8 maincontent" style="height:700px;" >
            ...
            <form class="row g-3"  action="/doctorregistration" method="post">
              
              <h1 style="font-family: serif;">Doctor Registration</h1>
              ...
              <div class="col-md-3">
                ...
                <select id="inputState" class="form-select" name="state" required="required">
